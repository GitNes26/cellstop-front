   ...
   return (
      <>
         <StatCardGrid columns={{ xs: 2, sm: 3, md: 4, lg: 6 }} gap={2}>
            <StatCard title="Chips Totales" value="12,540" subtitle="En inventario" color="primary" size="compact" trend={{ value: 12, isPositive: true }} />
            <StatCard title="Pre-activados" value="8,430" subtitle="Listos para asignar" color="success" size="small" progress={67} priority="medium" />
            <StatCard
               title="Distribuidos"
               value="1,890"
